...
"[project]/node_modules/.pnpm/@neondatabase+serverless@0.7.2/node_modules/@neondatabase/serverless/index.mjs [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var In = I((it)=>{
    ...
    it.toByteArray = uo;
    it.fromByteArray = lo;
    var oe = [], ee = [], so = typeof Uint8Array < "u" ? Uint8Array : Array, It = "ABCDEFGHIJKLMNO\
...
rowser support.");
    ...
    function le(r) {
        if (r > st) throw new RangeError('The\
 value "' + r + '" is invalid for option "size"');
    ...
    function f(r, e, t) {
        if (typeof r == "number") {
            if (typeof e == "string") throw new TypeError('The "string" argument must \
be of type string. Received type number');
            return Ft(r);
        }
        return Fn(r, e, t);
    }
...
fer");
    ...
    function Fn(r, e, t) {
        ...
        if (r == null) throw new TypeError("The first argument must b\
e one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received\
 type " + typeof r);
        ...
        if (typeof r == "number") throw new TypeError('The "value" argument must not be o\
f type number. Received type number');
        ...
        throw new TypeError("The first argument must be one of type strin\
g, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + typeof r);
    }
    a(Fn, "from");
...
ing: " + e);
    ...
    f.compare = a(function(e, t) {
        if (ae(e, Uint8Array) && (e = f.from(e, e.offset, e.byteLength)), ae(t, Uint8Array) && (t = f.from(t, t.offset, t.byteLength)), !f.isBuffer(e) || !f.isBuffer(t)) throw new TypeError('The "buf1", "buf2" arguments\
...
s");
    ...
    f.prototype.compare = a(function(e, t, n, i, s) {
        if (ae(e, Uint8Array) && (e = f.from(e, e.offset, e.byteLength)), !f.isBuffer(e)) throw new TypeError('The "target" argument must be one of type Buffe\
...
ved type ' + typeof r);
    ...
    a(ut, "checkListener");
    Object.defineProperty(B, "defaultMaxLi\
steners", {
        enumerable: !0,
        get: function() {
            return Kn;
...
out of range. It must be a non-negative number. Received ' + r + ".");
    ...
    B.prototype.setMaxListeners = a(function(e) {
        if (typeof e != "number" || e < 0 || Vn(e)) throw new RangeError('The value of "n" is out of range. It must be a non-nega\
tive number. Received ' + e + ".");
...
_onceWrap");
    ...
    B.prototype.removeListener = a(function(e, t) {
        ...
        if (n === t || n.listener === t) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete i[e], i.removeListener && this.emit("removeList\
ener", e, n.listener || t));
    ...
    B.prototype.removeAllListeners = a(function(e) {
        ...
        if (arguments.length === 0) {
            ...
            for(i = 0; i < s.length; ++i)o = s[i], o !== "removeList\
ener" && this.removeAllListeners(o);
            return this.removeAllListeners("removeListener"), this._events = Object.create(null), this._eventsCount = 0, this;
        }
        if (t = n[e], typeof t == "f\
unction") this.removeListener(e, t);
    ...
    function Jn(r, e, t) {
        ...
        if (n === void 0) return [];
        var i = n[e];
        return i === void 0 ? [] : typeof i == "functi\
on" ? t ? [
            i.listener || i
        ] : [
            i
...
var O, Ke, ni = K(()=>{
 ...
 supports code points up to U+10FFFF");
    ...
    a(O, "Md5"), T(O, "stateIdentity", new Int32Array([
        ...
        0,
        0
    ])), T(O, "hexChars", "0123456789abcdef"), T(O, "hexO\
ut", []), T(O, "onePassHasher", new O);
    Ke = O;
});
var Ut = {};
X(Ut, {
...
M",
    ...
    var Ht = "([+-]?\\d+)", ca = Ht + "\\s+years?", ha = Ht + "\\s+mons?", la = Ht + "\
...
pareValue");
    ...
    function Ka(r) {
        ...
        t && (e = Math.abs(e) + 1);
        var n = j(e, 4) + "-" + j(r.getUTCMonth() + 1, 2) + "-" + j(r.getUTCDate(), 2) + "\
T" + j(r.getUTCHours(), 2) + ":" + j(r.getUTCMinutes(), 2) + ":" + j(r.getUTCSeconds(), 2) + "." + j(r.getUTCMilliseconds(), 3);
...
function" ? r.callback = e : r.values = e), t && (r.callback = t), r;
    ...
    a(Va, "normalizeQueryConfi\
g");
    var Zt = a(function(r) {
        return Wa.createHash("md5").update(r, "utf-8").digest("h\
ex");
...
se", r.serverSignature = J.toString("base64"), r.response = l + ",p=" + P;
    }
    a(Za, "continueSe\
ssion");
    function Ja(r, e) {
...
hars");
    ...
    function eu(r) {
        ...
        if (t) {
            if (!Xa(t)) throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAG\
...
nt");
    ...
    a(eu, "parseServerFirstMe\
ssage");
    function tu(r) {
        let t = Oi(r).get("v");
        if (t) {
            if (!Di(t)) throw new Error("SAS\
...
`);
    ...
    fe.exports.getFileName = function(r) {
        var e = r || m.env, t = e.PGPASSFILE || (dt ? $i.join(e.APPDATA || "./", "postgresql", "pgpass.conf") : $i.join(e.HOME || "./", ".p\
gpass"));
        return t;
    };
    fe.exports.usePgPass = function(r, e) {
        return Object.prototype.hasOwnProperty.call(m.env, "PGPASSWORD") ? !1 : dt ? !0 : (e = e || "<unkn>", bu(r.mode) ? r.mode & (yu | mu) ? (ur('\
WARNING: password file "%s" has group or world access; permissions should be u=r\
w (0600) or less', e), !1) : !0 : (ur('WARNING: password file "%s" is not a plain file', e), !1));
    };
    ...
    fe.exports.getPassword = function(r, e, t) {
        ...
        var o = a(function() {
            ...
            e.destroy(), ur("WARNING: error on reading file: %\
s", c), t(void 0);
        }, "onErr");
...
http:" + r.substring(t.length), { username: i, password: s, host: o, hostname: u, port: c, pathname: h, search: l, searchParams: y, hash: E } = new URL(n);
...
teParamValue"), re = a(function(r, e, t) {
        var n = e[t];
...
d"), mr = class mr {
        constructor(e){
            e = typeof e == "string" ? ns(e) : e || {}, e.connectionString && (e = Object.assign({}, e, ns(e.connectionString))), this.user = V("user", e), this.database = V("database", e), this.database === void 0 && (this.database = this.user), this.port = parseInt(V("port", e), 10), this.host = V("host", e), Object.defineProperty(this, "password", {
                ...
                writable: !0,
                value: V("password", e)
            }), this.binary = V("binary", e), this.options = V("options", e), this.ssl = typeof e.ssl > "u" ? Tu() : e.ssl, typeof this.ssl == "st\
...
_name"), re(t, this, "fallback_application_name"), re(t, this, "connect_timeout"), re(t, this, "options");
...
ent_encoding=" + ke(this.client_encoding)), Iu.lookup(this.host, function(i, s) {
...
ext") : this._parsers[t] = Pu.getTypeParser(n.dataTypeID, n.format || "text");
            }
        }
    };
    a(wr, "\
...
OnlyBuffer"), Yu = St(72), Zu = St(83), Ju = St(88), Xu = St(99), ec = {
        startup: Ru,
        password: Mu,
        requestSsl: Fu,
...
var vs = I((qe)=>{
    ...
    var M = zr(), ic = ws(), sc = nc((Ss(), k(bs))), rn = 1, oc = 4, xs = rn + oc, Es = d.allocUnsafe(0), sn = class sn {
        constructor(e){
            if (this.buffer = Es, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new ic.BufferReader, e?.mode === "binary") throw new Error("Binary mod\
e not supported yet");
...
not use a pool after calling end on the pool");
            ...
            if (this._isFull() || this._idle.length) {
                ...
                let i = a((u, c, h)=>{
                    ...
                    Fs(this._pendingQueue, (u)=>u.callback === i), s.timedOut = !0, t.callback(new Error("timeout exceeded when try\
ing to connect"));
...
ion terminated due to connection timeout"), this._pulseQueue(), e.timedOut || e.callback(o, void 0, Rs);
                else {
...
var Qs = I((pf, Ns)=>{
    ...
    var qs = ge().EventEmitter, Tc = (Ge(), k(He)), gn = tt(), Qe = Ns.exports = function(r, e, t) {
        qs.call(this), r = gn.normalizeQueryConfig(r, e, t), this.text = r.text, this.values = r.values, this.name = r.name, this.callback = r.callback, this.state = "new", this._arrayMode = r.rowMode === "array", this._emitRowEvents = !1, this.on("\
...
ool"), e;
    ...
    typeof m.env.NODE_PG_FORCE_NATIVE < "u" ? nt.exports = new bn(wn()) : (nt.exports = new bn(Mc), Object.defineProperty(nt.exports, "na\
tive", {
        configurable: !0,
        enumerable: !1,
        get () {
...
a(Sn, "NeonDbError");
var Ae = Sn, Ks = "transaction() expects an array of queries, or a function returning an array \
of queries";
function Ys(r, { arrayMode: e, fullResults: t, fetchOptions: n, isolationLevel: i, readOnly: s, deferrable: o, queryCallback: u, resultCallback: c } = {}) {
    if (!r) throw new Error("No database connection string was provided to `neon()`. Perhaps an environment \
variable has not been set?");
    let h;
    try {
        h = lr(r);
    } catch  {
        throw new Error("Database c\
onnection string provided to `neon()` is not a valid URL. Connection string: " + String(r));
    }
    let { protocol: l, username: y, password: E, hostname: _, port: P, pathname: N } = h;
    if (l !== "postgres:" && l !== "postgresql:" || !y || !E || !_ || !N) throw new Error("Database connect\
...
name?option=value");
    ...
    async function pe(A, g) {
        ...
        let he = {
            ...
            "Ne\
on-Raw-Text-Output": "true",
            "Neon-Array-Mode": "true"
        };
        Q === !0 && (he["Neon-Pool-Opt-\
In"] = "true"), Array.isArray(A) && (ce !== void 0 && (he["Neon-Batch-Isolation-Level"] = ce), ye !== void 0 && (he["Neon-Batch-Read-Only"] = String(ye)), xe !== void 0 && (he["Neon-Batc\
h-Deferrable"] = String(xe)));
        let ie;
        try {
            ie = await (W ?? fetch)(ue, {
                method: "POST",
...
base: ${se.message}`);
        ...
        if (ie.ok) {
            ...
            if (Array.isArray(A)) {
                let $ = se.results;
                if (!Array.isArray($)) throw new Ae("Neon in\
ternal error: unexpected result format");
...
se set the host to 'localhost' explicitly.`);
    ...
    async _handleAuthSASLContinue(t) {
        ...
        let o = Object.fromEntries(s.split(",").map(($)=>{
            if (!/^.=/.test($)) throw new Error("SASL: Invali\
...
HMAC",
        ...
        var se = d.from(await w.subtle.sign("HMA\
C", ie, E.encode(de)));
        n.message = "SASLResponse", n.serverSignature = se.toString("bas\
e64"), n.response = ue + ",p=" + ye, this.connection.sendSCRAMClientFinalMessage(this.saslSession.response);
    }
};
a(En, "NeonClient");
var xn = En;
...
//# sourceMappingURL=1cd2b_%40neondatabase_serverless_index_mjs_cae6fa._.js.map